...
from settings import key_path,config_path

#決定金鑰跟config檔位置


def smtp(send_from:str,to_list:list,subject:str,body:str,file_path=None,file_name=None) -> None:
